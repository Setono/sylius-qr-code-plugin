        ...
        $rootNode
            ...
            ->children()
                ->integerNode('redirect_type')
                    ->info('HTTP status code returned by the public /qr/{slug} redirect. 302 is the safe default — 301 gets cached aggressively by browsers and crawlers, which prevents repointing the slug.')
                    ->defaultValue(302)
                    ->validate()
